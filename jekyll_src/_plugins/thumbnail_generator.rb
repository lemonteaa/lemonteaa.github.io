# Credit: https://github.com/oturpe/jekyll-thumbnail-generator
# Modified by lemonteaa to support turning off cover image
require 'rmagick'
include Magick
...
module Jekyll
  class GenerateThumbnails < Generator
    ...
    Thumbnail_cover = { 'generates' => true, 'width' => 400, 'height' => 240 }
    ...
    def generate(site)
        ...
        site.posts.docs.each do |post|
            ...
            if post.data['hascover'] || (post.data['hascover'].nil? && thumbnail_cover['generates'])
